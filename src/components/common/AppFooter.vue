...
@media (max-width: 768px) {
  ...
  .mobile-logo { height: 28px; max-width: 100px; }
  .mobile-nav { width: 85%; max-width: 300px; padding: 1.5rem 1.2rem; }
  .mobile-link { font-size: 1.3rem; }
  .mobile-nav-links { gap: 1rem; }
  .app-header { padding: 0.8rem 0; }
  .app-header.scrolled { padding: 0.4rem 0; }
}
...
@media (max-width: 480px) {
  ...
  .mobile-logo { height: 24px; max-width: 80px; }
  .mobile-nav { width: 90%; max-width: 280px; padding: 1.2rem 1rem; }
  .mobile-link { font-size: 1.2rem; }
  .mobile-nav-links { gap: 0.8rem; }
  .btn-book-mobile { padding: 0.8rem; font-size: 0.9rem; min-height: 44px; }
  .close-menu { font-size: 1.3rem; padding: 0.3rem; min-width: 40px; min-height: 40px; }
  .hamburger { width: 20px; gap: 3.5px; }
  .hamburger span { height: 1.8px; }
  .app-header { padding: 0.6rem 0; }
  .app-header.scrolled { padding: 0.3rem 0; }
