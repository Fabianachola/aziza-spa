  ...
  <section class="cta-section">
    <div class="container">
      <div class="cta-wrapper">
        <h2 class="cta-title">Your Moment of Relaxation Awaits</h2>
        <p class="cta-description">
          Take time for yourself with treatments designed to restore balance, renew your skin, 
        ...
        <div class="cta-buttons">
          ...
          <a href="https://wa.me/254796471899" target="_blank" class="btn-whatsapp">
          ...
          <a href="tel:+254796471899" class="btn-call">
